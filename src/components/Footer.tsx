    ...
    return (
        <footer className="bg-[#1A1A1A] text-white py-12 md:py-16">
            <div className="container-width grid grid-cols-1 md:grid-cols-3 gap-12">
                ...
                {/* Quick Links */}
                <div className="space-y-4">
                    <h3 className="text-sm font-semibold text-gray-200 uppercase tracking-widest">Connect</h3>
                    <ul className="space-y-3 text-sm text-gray-400">
                        <li><Link href="/books" className="hover:text-white transition-colors">Our Books</Link></li>
                        <li><Link href="/systems" className="hover:text-white transition-colors">Survival Systems</Link></li>
                ...
                <div className="space-y-4 text-xs text-gray-500 leading-relaxed">
                    ...
                    <p className="pt-4 border-t border-gray-800">
                        &copy; {new Date().getFullYear()} Moabyte Press. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
